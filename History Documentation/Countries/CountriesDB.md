...
```yaml:dbfolder
name: Countries
description: A list of countries/nations
columns:
  __file__:
    key: __file__
    id: __file__
  ...
  country-tags:
    ...
    sortIndex: -1
    options:
      - { label: "refugees", value: "refugees", color: "hsl(247, 95%, 90%)"}
      - { label: "major", value: "major", color: "hsl(149, 95%, 90%)"}
